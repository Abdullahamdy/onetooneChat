            ...
            <div class="card">
                <div class="row g-0">
                    <div class="col-12 col-lg-5 col-xl-3 border-right">
                        ...
                        <a class="list-group-item list-group-item-action border-0 reciver_id" v-for="(friend, i) in users"
                            :key="friend.id"
                             v-if="friend.id != user.id"
                             >
                            ...
                            <div class="d-flex align-items-start">
                                <img :src="'Images/' + friend.image" class="rounded-circle mr-1" alt="Vanessa Tucker"
                                    width="40" height="40">
                                <div class="flex-grow-1 ml-3 btn"
                        ...
                        <div class="py-2 px-4 border-bottom d-none d-lg-block">
                            <div class="d-flex align-items-center py-1">
                                <div class="position-relative">
                                    <img :src="'Images/' + activeFriend.image" v-if="activeFriend" class="rounded-circle mr-1"
